...
| 1.12 | Win condition: Stop game when all collectables cleared                         | Done   |
| 1.13 | Timer display: Show elapsed time in HUD                                        | Done   |
...
| --- | ------------------------ | ---------------------------------------- | ------ |
| 2.1 | Reserved keys            | Implement `=`, `Backspace`, `]`, `Enter` | Done   |
| 2.2 | Level data structure     | Define level format with items array     | Done   |
| 2.3 | Demo level               | Endless mode, auto-respawn collectables  | Done   |
| 2.4 | Predefined levels (×3)   | Fixed layouts with spawn positions       | Done   |
| 2.5 | Level switching          | `=` next, `Backspace` prev               | Done   |
| 2.6 | Dynamic level generation | Random placement with `]` to regenerate  | Done   |
| 2.7 | Obstacle item (`█`)      | Blocking collision                       | Done   |
| 2.8 | Portal item (`◯`)        | Paired teleportation                     | Done   |
