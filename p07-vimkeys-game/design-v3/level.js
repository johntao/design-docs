  ...
  demo: [
    {
      ...
      items: [
        { type: 'coinYellow', row: 2, col: 2 },
        { type: 'coinYellow', row: 2, col: 7 },
        { type: 'coinYellow', row: 7, col: 2 },
        { type: 'coinYellow', row: 7, col: 7 },
        { type: 'coinYellow', row: 5, col: 5 },
      ]
    },
    {
      id: 'demo_2',
      ...
      playerSpawn: { row: 4, col: 4 },
      items: [
        { type: 'coinYellow', row: 1, col: 1 },
        { type: 'coinYellow', row: 1, col: 8 },
        { type: 'coinYellow', row: 8, col: 1 },
        { type: 'coinYellow', row: 8, col: 8 },
  ...
  predefined: [
    {
      ...
      items: [
        ...
        { type: 'coinYellow', row: 7, col: 7 },
        { type: 'coinYellow', row: 5, col: 5 },
        // { type: 'coinYellow', row: 3, col: 3 },
        // { type: 'coinYellow', row: 3, col: 6 },
        // { type: 'coinYellow', row: 6, col: 3 },
        // { type: 'coinYellow', row: 6, col: 6 },
    ...
    },
    {
      ...
      items: [
        ...
        { type: 'sigil', letter: 'f', row: 1, col: 4 },
        { type: 'sigil', letter: 'f', row: 8, col: 4 },
        // { type: 'coinYellow', row: 0, col: 0 },
        // { type: 'coinYellow', row: 0, col: 9 },
        // { type: 'coinYellow', row: 9, col: 0 },
        // { type: 'coinYellow', row: 9, col: 9 },
    ...
    },
    {
      ...
      items: [
        { type: 'coinYellow', row: 1, col: 4 },
        { type: 'coinYellow', row: 4, col: 1 },
        { type: 'coinYellow', row: 4, col: 8 },
        { type: 'coinYellow', row: 8, col: 4 },
    ...
    },
    {
      ...
      playerSpawn: { row: 4, col: 4 },
      items: [
        { type: 'coinYellow', row: 0, col: 4 },
        { type: 'coinYellow', row: 4, col: 0 },
        { type: 'coinYellow', row: 4, col: 9 },
        { type: 'coinYellow', row: 9, col: 4 },
