  ...
  demo: [
    {
      ...
      items: [
        ...
        { type: 'coin', row: 2, col: 7 },
        { type: 'coin', row: 7, col: 2 },
        { type: 'coin', row: 7, col: 7 },
    ...
    },
    {
      ...
      playerSpawn: { row: 4, col: 4 },
      items: [
        { type: 'coin', row: 1, col: 1 },
        { type: 'coin', row: 1, col: 8 },
        { type: 'coin', row: 8, col: 1 },
        { type: 'coin', row: 8, col: 8 },
        { type: 'sigil', letter: 'a', row: 0, col: 0 },
        { type: 'sigil', letter: 'a', row: 0, col: 9 },
        { type: 'sigil', letter: 'a', row: 9, col: 0 },
        { type: 'sigil', letter: 'a', row: 9, col: 9 },
        { type: 'sigil', letter: 's', row: 2, col: 5 },
        { type: 'sigil', letter: 's', row: 5, col: 2 },
        { type: 'sigil', letter: 's', row: 5, col: 7 },
        { type: 'sigil', letter: 's', row: 7, col: 5 },
        { type: 'sigil', letter: 'd', row: 3, col: 3 },
        { type: 'sigil', letter: 'd', row: 3, col: 6 },
        { type: 'sigil', letter: 'd', row: 6, col: 3 },
        { type: 'sigil', letter: 'd', row: 6, col: 6 },
        { type: 'sigil', letter: 'f', row: 1, col: 4 },
        { type: 'sigil', letter: 'f', row: 4, col: 1 },
        { type: 'sigil', letter: 'f', row: 4, col: 8 },
    ...
    },
    {
      ...
      items: [
        ...
        { type: 'sigil', letter: 'a', row: 1, col: 8 },
        { type: 'sigil', letter: 'a', row: 8, col: 1 },
        { type: 'sigil', letter: 'a', row: 8, col: 8 },
        { type: 'sigil', letter: 's', row: 3, col: 5 },
        { type: 'sigil', letter: 's', row: 5, col: 3 },
        { type: 'sigil', letter: 's', row: 5, col: 6 },
        { type: 'sigil', letter: 's', row: 6, col: 5 },
        { type: 'sigil', letter: 'd', row: 0, col: 2 },
        { type: 'sigil', letter: 'd', row: 0, col: 7 },
        { type: 'sigil', letter: 'd', row: 9, col: 2 },
        { type: 'sigil', letter: 'd', row: 9, col: 7 },
        { type: 'sigil', letter: 'f', row: 1, col: 5 },
        { type: 'sigil', letter: 'f', row: 5, col: 1 },
        { type: 'sigil', letter: 'f', row: 5, col: 8 },
  ...
  predefined: [
    {
      ...
      items: [
        { type: 'coin', row: 3, col: 3 },
        { type: 'coin', row: 3, col: 6 },
        { type: 'coin', row: 6, col: 3 },
        ...
        { type: 'sigil', letter: 's', row: 4, col: 2 },
        { type: 'sigil', letter: 's', row: 4, col: 7 },
        { type: 'sigil', letter: 's', row: 7, col: 4 },
        { type: 'sigil', letter: 'd', row: 0, col: 4 },
        { type: 'sigil', letter: 'd', row: 4, col: 0 },
        { type: 'sigil', letter: 'd', row: 4, col: 9 },
    ...
    },
    {
      ...
      items: [
        { type: 'coin', row: 0, col: 0 },
        { type: 'coin', row: 0, col: 9 },
        { type: 'coin', row: 9, col: 0 },
        ...
        { type: 'sigil', letter: 's', row: 4, col: 0 },
        { type: 'sigil', letter: 's', row: 5, col: 9 },
        ...
        { type: 'sigil', letter: 'f', row: 4, col: 5 },
        { type: 'sigil', letter: 'f', row: 5, col: 4 },
    ...
    },
    {
      ...
      items: [
        ...
        { type: 'sigil', letter: 's', row: 3, col: 6 },
        { type: 'sigil', letter: 's', row: 6, col: 3 },
        { type: 'sigil', letter: 's', row: 6, col: 6 },
        { type: 'sigil', letter: 'd', row: 2, col: 4 },
        { type: 'sigil', letter: 'd', row: 4, col: 2 },
        { type: 'sigil', letter: 'd', row: 4, col: 7 },
        { type: 'sigil', letter: 'd', row: 7, col: 4 },
        { type: 'sigil', letter: 'f', row: 2, col: 7 },
        { type: 'sigil', letter: 'f', row: 7, col: 2 },
        { type: 'sigil', letter: 'f', row: 3, col: 8 },
        { type: 'sigil', letter: 'f', row: 8, col: 3 },
      ]
    },
    {
      id: 'level_4',
      ...
      playerSpawn: { row: 4, col: 4 },
      items: [
        { type: 'coin', row: 0, col: 4 },
        { type: 'coin', row: 4, col: 0 },
        ...
        { type: 'sigil', letter: 's', row: 2, col: 0 },
        { type: 'sigil', letter: 's', row: 7, col: 9 },
        { type: 'sigil', letter: 's', row: 9, col: 7 },
        { type: 'sigil', letter: 'd', row: 3, col: 4 },
        { type: 'sigil', letter: 'd', row: 4, col: 3 },
        { type: 'sigil', letter: 'd', row: 5, col: 4 },
        { type: 'sigil', letter: 'd', row: 4, col: 5 },
        { type: 'sigil', letter: 'f', row: 0, col: 5 },
        { type: 'sigil', letter: 'f', row: 5, col: 0 },
        { type: 'sigil', letter: 'f', row: 5, col: 9 },
